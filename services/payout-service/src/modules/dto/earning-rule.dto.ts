...
export class IncentiveTierDto {
  @ApiProperty({
    example: 25,
    minimum: 1,
    description: 'Deliveries in the month that unlock the bonus.',
  })
  @Type(() => Number)
  @IsInt()
  @Min(1)
...
export class ApplyEarningRuleDto {
  @ApiPropertyOptional({
    format: 'uuid',
    description: 'Depot the rule applies to; omit for the network default.',
  })
  @IsOptional()
  @IsUUID()
  depotId?: string;
  ...
  @ApiProperty({
    example: 2000,
    minimum: 0,
    description: 'Bonus added when the delivery completes in peak hours.',
  })
  @Type(() => Number)
  @IsNumber()
  @Min(0)
  ...
  @ApiProperty({
    example: 1000,
    minimum: 0,
    description: 'Bonus added when the delivery beat its SLA.',
  })
  @Type(() => Number)
  @IsNumber()
  @Min(0)
  ...
  @ApiProperty({
    ...
    minimum: 0,
    maximum: 23,
    description: 'Peak window start hour (WIB).',
  })
  @Type(() => Number)
  @IsInt()
  @Min(0)
  ...
  @ApiProperty({
    ...
    minimum: 1,
    maximum: 24,
    description: 'Peak window end hour (WIB, exclusive).',
  })
  @Type(() => Number)
  @IsInt()
  @Min(1)
  ...
  @ApiPropertyOptional({
    example: 5000000,
    minimum: 0,
    description: 'Monthly earnings target (IDR); 0 = none.',
  })
  @IsOptional()
  @Type(() => Number)
  @IsNumber()
  ...
  @ApiPropertyOptional({
    ...
    description: 'Monthly incentive ladder; omit for none.',
  })
  @IsOptional()
  @IsArray()
  @ArrayMaxSize(10)
