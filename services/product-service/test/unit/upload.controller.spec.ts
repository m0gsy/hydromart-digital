...
describe('UploadController (product images)', () => {
  const storage: StoragePort = {
    put: jest
      .fn()
      .mockResolvedValue({ url: 'http://x/uploads/products/abc.png', key: 'products/abc.png' }),
  };
  ...
  it('accepts a png and returns the storage url', async () => {
    ...
    expect(result).toEqual({ url: 'http://x/uploads/products/abc.png' });
