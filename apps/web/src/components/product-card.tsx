  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-[3px] p-4">
        ...
        {/* A1. `min-w-0` on the price column, because a flex child's default `min-width:auto`
            refuses to shrink below its content and that is what pushed the button out of the
            card entirely. `flex-wrap` is the second half: when even the shrunk column plus a
            40px button will not fit 104px, the button drops to its own line instead of
            leaving the card. */}
