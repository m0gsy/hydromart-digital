...
export const order: typeof base = {
  ...
  checkout: {
    ...
    courierNotesPlaceholder: 'e.g. green gate next to the corner shop, leave with security',
    courierNotesHint: 'Helps the courier find your door. Saved with the address if you save it.',
    pinAccuracy: 'Accuracy ±{m} m',
    pinNearDepot: 'near {depot} · {km} km',
    savePinRequired: 'Take a map pin first — an address without one cannot be saved.',
    saveAddressFailed: 'Your order was placed, but the address was not saved to your address book.',
