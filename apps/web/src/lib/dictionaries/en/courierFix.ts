...
export const courierFix = {
  ...
  shiftGoal: {
    ...
    deliveriesLabel: 'Deliveries this week · of {target}',
    deliveriesNoTarget: 'Deliveries this week',
    ...
    tiersWindow: 'Counted per calendar month at your depot · {n} deliveries so far',
