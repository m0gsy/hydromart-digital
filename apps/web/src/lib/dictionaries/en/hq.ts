...
export const hq = {
  ...
  nav: {
    ...
    hierarchy: 'Supervision hierarchy',
    opsConsole: 'Depot console',
  ...
  access: {
    ...
    caps: {
      ...
      meterRead: 'View water meter',
      meterWrite: 'Record water meter',
      ...
      depotMaintenance: 'Asset maintenance',
      depotTargets: 'Depot targets',
      depotWholesale: 'Wholesale / B2B',
      ...
      fraudReview: 'Review fraud flags',
      refundIssue: 'Raise a refund',
      refundQueue: 'Decide a refund',
      settlementRead: 'Settlement & reconciliation ledger',
      hqPayout: 'Release a franchise payout',
      hqPayoutRead: 'View the payout queue',
      hqPayoutApprove: 'Approve a payout request',
      ...
      audienceReach: 'Broadcast audience size',
      taxSettings: 'Depot tax settings',
      loyaltyAdjust: 'Adjust customer points',
      loyaltyRead: 'Read loyalty & referral figures',
      rewardCatalog: 'Manage the reward catalogue',
      customerDirectory: 'Customer directory (marketing)',
      orderFulfilment: 'Move orders through fulfilment',
      deliveryReports: 'Delivery & SLA reports',
      depotOperationalReport: 'Depot operational report',
      customerPhoneLookup: 'Look up a customer by phone',
      customerNameLookup: 'Look up customer names (reseller console)',
      platformAdmin: 'Platform settings (API keys, flags, retention)',
      ownNotifPrefs: 'Manage own notification prefs',
      earningRules: 'Courier earning rules',
      settingsGlobal: 'GLOBAL settings',
      accessMatrixWrite: 'Edit this matrix',
      staffDirectory: 'View the staff directory',
      depotDirectory: 'View a depot in full',
      hqConsole: 'The HQ console door — who may enter at all',
      hqBackOffice: 'HQ back-office tooling (flags, SLA, tickets, exports, audit trail)',
    },
    landingLink: 'Per-role views',
    dirtyTitle: '{n} capabilities changed',
    dirtyBody: 'Not saved yet. Hit Save to apply this across every service.',
    reset: 'Discard',
    save: 'Save',
    saving: 'Saving…',
    propagation: 'Once saved, every service picks it up within 30 seconds.',
    diff: 'View diff / Copy',
    diffTitle: 'Change summary',
    diffHint: 'A text copy for your change log — saving still happens via the Save button.',
    copy: 'Copy',
    copied: 'Copied',
    footer:
      'The server stays authoritative: this console writes the same matrix the guards enforce.',
  ...
  depots: {
    ...
    form: {
      ...
      ownerHint: "Required for a franchise depot — its revenue is booked to this owner's ledger.",
      ownerPick: 'Pick an owner…',
      ownerEmpty: 'No franchise-owner account yet. Create one in the staff directory first.',
      ownerLoadError: 'Could not load the franchise owners.',
      address: 'Address',
      city: 'City',
      province: 'Province',
      lat: 'Latitude',
      ...
      paymentHint: 'Optional — bank account & QRIS for transfer/COD to this depot.',
      bankName: 'Bank name',
      accountNumber: 'Account number',
      accountHolder: 'Account holder',
      qris: 'QRIS image URL',
      qrisHint: "Link to the depot's static QRIS image.",
      cancel: 'Cancel',
      save: 'Save changes',
      create: 'Create depot',
  ...
  hierarchy: {
    ...
    pickStaffNone: '— pick —',
    pickFirst: 'Pick an account to see its superior, reports and supervised depots.',
  ...
  staff: {
    ...
    form: {
      ...
      hint: 'A registered number is promoted; a new number gets an active staff account (OTP login). The employment details below also open their HR record.',
      position: 'Position',
      joinDate: 'Join date',
      employmentStatus: 'Employment status',
      employment: { TRAINING: 'Training', PROBATION: 'Probation', PERMANENT: 'Permanent' },
      salary: 'Salary',
      salaryMonthly: 'Monthly',
      salaryDaily: 'Daily',
      employmentRequired: 'Position and salary are required — they open the HR record.',
    },
  },
  search: {
    title: 'Search',
  ...
  payments: {
    ...
    release: {
      ...
      requested: 'Release request for {owner} sent, waiting for approval',
      empty: 'No payout pending.',
      queueTitle: 'Release requests awaiting approval',
      queueHint:
        'The requester cannot approve their own request. The balance leaves only once approved.',
      queueEmpty: 'No request awaiting approval.',
      requestedBy: 'Requested by {actor}',
      approve: 'Approve & release',
      reject: 'Reject',
      approved: 'Request approved, payout released',
      rejected: 'Request rejected',
      confirmApprove: "Approve this request? The owner's balance is debited and transferred.",
      confirmReject: 'Reject this request? No balance moves.',
    },
    accounts: {
      title: 'Payout destinations awaiting verification',
      hint: 'Match the name and the number before verifying. Payouts only go to verified accounts.',
      empty: 'No account awaiting verification.',
      verify: 'Verify',
      reject: 'Reject',
      verified: 'Account verified',
      rejected: 'Account rejected',
      confirmVerify: 'Verify this account? The next payout goes there.',
      confirmReject: 'Reject this account? Its owner has to register again.',
      owner: 'Franchise owner',
      courier: 'Courier',
    },
    settle: {
      title: 'Withdrawals awaiting a bank result',
      hint: 'PROCESSING means the balance is already debited. Mark PAID once the transfer clears, or FAILED to give the balance back.',
      franchise: 'Franchise owners',
      courier: 'Couriers',
      empty: 'Nothing awaiting a bank result.',
      paid: 'Paid',
      failed: 'Failed',
  ...
  refunds: {
    ...
    approve: 'Approve',
    reject: 'Reject',
    rejectTitle: 'Reject this refund?',
    rejectMessage: 'The refund for {order} will be rejected. The money stays with the business, so a reason is required and is recorded under your name.',
    rejectReason: 'Reason for rejecting',
    rejectReasonHint: 'e.g. replaced on the spot',
    cannotRejectCancelled: 'Order cancelled — the refund is owed',
    cannotRejectUnknown: 'Order status unreadable — reload and try again',
    ...
    enrichNote:
      'Depot name & order number are not shown yet (owned by other services); amount, method, reason & decision are real.',
  },
  vouchers: {
  ...
  reconciliation: {
    ...
    downloaded: 'Reconciliation file downloaded',
  ...
  forms: {
    ...
    segment: {
      ...
      saveTitle: 'Save this segment',
      namePh: 'Segment name',
      save: 'Save',
      saved: 'Segment saved',
      saveError: 'Could not save the segment.',
      needName: 'Name the segment first.',
      needCondition: 'Add at least one condition that can be applied.',
    },
  },
  inventory: {
  ...
  // CA-2-59: network profit and loss, from recorded costs only.
  pnl: {
    title: 'Network profit and loss',
    ...
    colRevenue: 'Revenue',
    colCogs: 'Goods',
    colPayroll: 'Wages & allowances',
    colCommission: 'Courier commission',
    colClaims: 'Expense claims',
    colRefunds: 'Refunds',
    colNet: 'Net profit',
    total: 'Network',
    inactive: '(inactive)',
    empty: 'No depots to report on yet.',
    unreadable: 'Some figures could not be read this month ({sources}), so they show as "—" rather than counting as zero.',
    source: {
      depot: 'depot list',
      order: 'revenue',
      goods: 'goods cost',
      payroll: 'wages',
      payout: 'commission & claims',
      refunds: 'refunds',
    },
  },
  compare: {
  ...
  campaigns: {
    ...
    fromSegmentBuilder: 'Using the conditions from Build Segment — the chips below are off.',
    chips: {
      all: 'All customers',
  ...
  customers: {
    ...
    loyaltyNone: 'No loyalty account yet.',
    recentOrders: 'Recent orders',
    noOrders: 'No orders yet.',
    ltv: 'Lifetime value',
    orderCount: 'Orders',
    pointsLabel: 'Points',
    pointsHint: 'May be negative for a correction. Cannot be zero.',
    pointsInvalid: 'Enter a whole number of points, not zero.',
    reasonLabel: 'Reason',
    reasonPlaceholder: 'Goodwill credit for a late delivery',
    reasonRequired: 'A reason is required.',
    givePointsError: 'Could not adjust the points.',
    givePoints: 'Give points',
    contact: 'Contact',
    gavePoints: 'Points granted to {name}',
  },
  catalog: {
    ...
    categories: {
      ...
      subtitle: 'The list behind the dropdown above and the pills on the shop',
      name: 'Category name',
      slug: 'URL slug',
      add: '＋ Category',
      rename: 'Edit',
      ...
      needName: 'Category name is required.',
      needSlug: 'A slug is required (lowercase and hyphens).',
  ...
  loyalty: {
    ...
    itemUnit: 'Unit',
    itemPoints: 'Points',
    itemStock: 'Stock (blank = unlimited)',
    saveItem: 'Save',
    retire: 'Retire',
    restore: 'Restore',
    retiredBadge: 'Retired',
    itemSaved: 'Reward catalogue updated.',
    itemSaveError: 'Could not update the reward catalogue.',
    itemCreated: 'Reward added.',
    itemCreateError: 'Could not add the reward.',
  ...
  franchise: {
    ...
    subtitle: 'Every franchise depot, its owner, the HQ cut, and what awaits release',
    count: '{n} depots',
    orphans: '{n} without an owner',
    empty: 'No franchise depots yet.',
    inactive: 'Inactive',
    noOwner: 'No owner — this depot books its revenue to nobody',
    ownerUnknown: 'Owner outside the staff directory',
    noScheme: 'no commission set',
    pct: '{n}% commission',
    pendingRow: 'awaiting release',
    pendingTitle: 'Awaiting release to owners',
    pendingHint: 'Total franchise-owner balance ready for HQ to release.',
    open: 'Open depot',
  },
  applications: {
  ...
  audit: {
    ...
    action: 'Action',
    time: 'Time',
    exportError: 'Could not build the export file.',
  ...
  flags: {
    ...
    unenforcedTitle: 'Not enforced yet',
    unenforcedBody:
      'No service reads these flags. Changing one saves the state here, but turns nothing on or off in the app — until the service concerned is made to read it.',
  ...
  sweeps: {
    ...
    subtitle:
      'Background jobs that run the money and data-retention paths. The list comes from the ' +
      'schedule, not from what reported in — so a sweep that has never run still appears.',
    job: 'Job',
    verdict: 'State',
    lastRun: 'Last run',
    lastOk: 'Last succeeded',
    every: 'Schedule',
    OK: 'Running',
    FAILING: 'Failing',
    OVERDUE: 'Overdue',
    NEVER_RAN: 'Never ran',
    DORMANT: 'Deliberately off',
    allRunning: 'All {total} sweeps running',
    brokenCount: '{n} of {total} sweeps in trouble',
    consecutive: '{n} consecutive failures',
  ...
  webhooks: {
    ...
    logEmpty: 'No deliveries recorded yet.',
    logError: 'Could not load the delivery log.',
    logAttempts: '{n} attempt(s)',
    logReplay: 'Send again',
    logReplayed: 'Delivery queued again',
    logReplayError: 'Could not queue that delivery again.',
    logReason: 'Failure reason:',
    delete: 'Delete',
  ...
  slaPolicy: {
    ...
    pctOnTime: '% on-time',
    deliveryNote:
      'Note: delivery-service still grades on-time delivery with its own threshold until it is wired to read this policy.',
    save: 'Save policy',
  ...
  pdp: {
    ...
    subtitle: 'UU PDP stage 1 data-subject rights: data copy and account deletion.',
    empty: 'No requests.',
    filterAll: 'All',
    ...
    approve: 'Approve',
    reject: 'Reject',
    rejectPrompt: 'Reason for refusal (the customer will read this)',
  ...
  retention: {
    ...
    datasets: {
      ...
      hr_employee_records: 'Employee records (HR)',
    },
  ...
  security: {
    ...
    sessionsNote: 'Your signed-in devices. End any you don’t recognize.',
  ...
  tickets: {
    ...
    detailOrder: 'Order',
    detailOpened: 'Opened',
    detailShow: 'Show thread',
    detailHide: 'Hide thread',
    detailThread: 'Thread',
    detailThreadEmpty: 'No messages yet.',
    author: { CUSTOMER: 'Customer', STAFF: 'Staff' },
    newTicket: 'New ticket',
    createTicket: 'Create ticket',
    created: 'Ticket created.',
    subjectPlaceholder: 'Summary of the complaint',
    customerPlaceholder: 'Customer name (a nickname is fine)',
    phonePlaceholder: 'Customer phone number',
    orderPlaceholder: 'Order number (optional)',
    bodyPlaceholder: 'What the customer said',
  ...
  scheduledReports: {
    ...
    datasetHint: 'What goes in the file.',
    datasets: {
      REVENUE_BY_DEPOT: 'Revenue by depot',
  ...
  onboarding: {
    ...
    pickPrompt: 'Pick a depot to see its go-live readiness.',
    ...
    derivedHint: 'Readiness is derived live from the depot record, stock, staff and payment setup.',
    empty: 'No steps yet.',
  },
  profile: {
    ...
    events: {
      ...
      newOrder: 'New depot order',
      lowStock: 'Low stock (depot)',
      courierFail: 'Courier failed to deliver',
      approval: 'New approval request',
      dailySummary: 'Daily depot summary',
    },
