...
export const opsFix = {
  ...
  reports: {
    ...
    lowStockBody: 'Check gallon stock on the Inventory tab before closing the books. The low threshold is flagged automatically.',
  ...
  earningRules: {
    ...
    cannotDelete: 'A rule that has been in force cannot be deleted. Apply a new rule effective today to change it.',
    empty: 'No rules yet',
  ...
  newLine: {
    ...
    subtitle: 'A stock line ties a catalog product to this depot. Without one the product can still be ordered and its stock never moves.',
    kind: 'Kind',
    product: 'Product',
  ...
  targets: {
    ...
    insight: 'Insight',
    insightBody: 'A yellow bar marks a KPI behind this month’s pace (day {day} of {days}). Point resources there to catch up.',
    gate: 'Depot managers only',
  ...
  settlements: {
    ...
    footer: 'Verification matches the physical cash against the courier COD total. A shortfall is recorded against the courier and shows in the deposit history in their app.',
