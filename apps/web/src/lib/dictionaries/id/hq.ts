...
export const hq = {
  ...
  access: {
    ...
    caps: {
      ...
      hqPayoutApprove: 'Setujui pengajuan pencairan',
      ...
      audienceReach: 'Hitung jangkauan broadcast',
      taxSettings: 'Atur pajak depot',
      loyaltyAdjust: 'Koreksi poin pelanggan',
      loyaltyRead: 'Lihat angka loyalti & referral',
      rewardCatalog: 'Kelola katalog hadiah',
      customerDirectory: 'Direktori pelanggan (marketing)',
      orderFulfilment: 'Proses pesanan di depot',
      deliveryReports: 'Laporan pengiriman & SLA',
      depotOperationalReport: 'Laporan operasional depot',
      customerPhoneLookup: 'Cari pelanggan lewat nomor HP',
      customerNameLookup: 'Cari nama pelanggan (konsol agen)',
      platformAdmin: 'Setelan platform (API key, flag, retensi)',
      ownNotifPrefs: 'Atur notifikasi sendiri',
      ...
      hqConsole: 'Pintu konsol HQ — siapa yang boleh masuk sama sekali',
      hqBackOffice: 'Perkakas back-office HQ (flag, SLA, tiket, ekspor, jejak audit)',
    },
  ...
  staff: {
    ...
    form: {
      ...
      role: 'Peran',
      depot: 'Depot penempatan (opsional)',
  ...
  payments: {
    ...
    release: {
      ...
      requested: 'Pengajuan rilis untuk {owner} dikirim, menunggu persetujuan',
      empty: 'Tidak ada payout menunggu.',
      queueTitle: 'Pengajuan rilis menunggu persetujuan',
      queueHint:
        'Pengaju tidak boleh menyetujui pengajuannya sendiri. Saldo baru keluar setelah disetujui.',
      queueEmpty: 'Tidak ada pengajuan menunggu.',
      requestedBy: 'Diajukan oleh {actor}',
      approve: 'Setujui & rilis',
      reject: 'Tolak',
      approved: 'Pengajuan disetujui, payout dirilis',
      rejected: 'Pengajuan ditolak',
      confirmApprove: 'Setujui pengajuan ini? Saldo pemilik akan dipotong dan ditransfer.',
      confirmReject: 'Tolak pengajuan ini? Tidak ada saldo yang bergerak.',
    },
    accounts: {
      title: 'Rekening tujuan menunggu verifikasi',
      hint: 'Cocokkan nama dan nomor rekening sebelum memverifikasi. Pencairan hanya ke rekening terverifikasi.',
      empty: 'Tidak ada rekening menunggu.',
      verify: 'Verifikasi',
      reject: 'Tolak',
      verified: 'Rekening diverifikasi',
      rejected: 'Rekening ditolak',
      confirmVerify: 'Verifikasi rekening ini? Pencairan berikutnya akan dikirim ke sana.',
      confirmReject: 'Tolak rekening ini? Pemiliknya harus mendaftarkan ulang.',
      owner: 'Pemilik waralaba',
      courier: 'Kurir',
    },
    settle: {
      title: 'Penarikan menunggu jawaban bank',
      hint: 'PROCESSING berarti saldonya sudah dipotong. Tandai LUNAS kalau transfernya masuk, atau GAGAL untuk mengembalikan saldonya.',
      franchise: 'Pemilik waralaba',
      courier: 'Kurir',
      empty: 'Tidak ada penarikan menunggu.',
      paid: 'Lunas',
      failed: 'Gagal',
  ...
  refunds: {
    ...
    approve: 'Setujui',
    reject: 'Tolak',
    rejectTitle: 'Tolak refund ini?',
    rejectMessage: 'Refund untuk {order} akan ditolak. Uang pelanggan tetap di perusahaan, jadi alasannya wajib ditulis dan tercatat atas nama Anda.',
    rejectReason: 'Alasan penolakan',
    rejectReasonHint: 'mis. barang sudah diganti di tempat',
    cannotRejectCancelled: 'Pesanan dibatalkan — refund wajib dikembalikan',
    cannotRejectUnknown: 'Status pesanan tidak terbaca — coba muat ulang',
  ...
  reconciliation: {
    ...
    lines: {
      ...
      commission: 'Komisi waralaba',
      deposit: 'Deposit galon',
      net: 'Net payout ke pemilik',
    },
    download: 'Unduh XLSX',
    downloaded: 'Berkas rekonsiliasi terunduh',
  ...
  // CA-2-59: laba-rugi jaringan, dari biaya yang sudah tercatat saja.
  pnl: {
    title: 'Laba rugi jaringan',
    subtitle: 'Per depot, {month}',
    operational: 'Laporan manajemen',
    monthLabel: 'Pilih bulan',
    colDepot: 'Depot',
    colRevenue: 'Omzet',
    colCogs: 'Barang',
    colPayroll: 'Gaji & tunjangan',
    colCommission: 'Komisi kurir',
    colClaims: 'Klaim biaya',
    colRefunds: 'Pengembalian',
    colNet: 'Laba bersih',
    total: 'Jaringan',
    inactive: '(nonaktif)',
    empty: 'Belum ada depot untuk dilaporkan.',
    unreadable: 'Sebagian angka tidak bisa dibaca bulan ini ({sources}), jadi ditulis "—" dan tidak dihitung sebagai nol.',
    source: {
      depot: 'daftar depot',
      order: 'omzet',
      goods: 'biaya barang',
  ...
  customers: {
    ...
    contact: 'Kontak',
    gavePoints: 'Poin diberikan ke {name}',
  },
  catalog: {
  ...
  loyalty: {
    ...
    itemUnit: 'Satuan',
    itemPoints: 'Poin',
    itemStock: 'Stok (kosongkan = tak terbatas)',
    saveItem: 'Simpan',
    retire: 'Pensiunkan',
    restore: 'Aktifkan lagi',
    retiredBadge: 'Pensiun',
    itemSaved: 'Katalog hadiah diperbarui.',
    itemSaveError: 'Gagal memperbarui katalog hadiah.',
    itemCreated: 'Hadiah ditambahkan.',
    itemCreateError: 'Gagal menambah hadiah.',
  ...
  flags: {
    ...
    unenforcedTitle: 'Belum ditegakkan',
    unenforcedBody:
      'Tidak ada layanan yang membaca flag ini. Mengubahnya menyimpan status di sini, tapi tidak menyalakan atau mematikan apa pun di aplikasi — sampai layanan yang bersangkutan dibuat membacanya.',
  ...
  webhooks: {
    ...
    logTitle: 'Riwayat pengiriman',
    logEmpty: 'Belum ada pengiriman tercatat.',
    logError: 'Gagal memuat riwayat pengiriman.',
    logAttempts: '{n}× percobaan',
    logReplay: 'Kirim ulang',
    logReplayed: 'Pengiriman diantrekan ulang',
    logReplayError: 'Gagal mengantrekan ulang pengiriman.',
    logReason: 'Alasan gagal:',
    delete: 'Hapus',
  ...
  tickets: {
    ...
    detailOrder: 'Pesanan',
    detailOpened: 'Dibuka',
    detailShow: 'Lihat percakapan',
    detailHide: 'Tutup percakapan',
    detailThread: 'Percakapan',
    detailThreadEmpty: 'Belum ada pesan.',
    author: { CUSTOMER: 'Pelanggan', STAFF: 'Staf' },
    newTicket: 'Tiket baru',
    createTicket: 'Buat tiket',
    created: 'Tiket dibuat.',
    subjectPlaceholder: 'Ringkasan keluhan',
    customerPlaceholder: 'Nama pelanggan (boleh nama panggilan)',
    phonePlaceholder: 'Nomor HP pelanggan',
    orderPlaceholder: 'Nomor pesanan (opsional)',
    bodyPlaceholder: 'Apa yang disampaikan pelanggan',
  ...
  profile: {
    ...
    events: {
      ...
      newOrder: 'Pesanan baru masuk (depot)',
      lowStock: 'Stok menipis (depot)',
      courierFail: 'Kurir gagal antar',
      approval: 'Permintaan approval baru',
      dailySummary: 'Ringkasan harian depot',
    },
