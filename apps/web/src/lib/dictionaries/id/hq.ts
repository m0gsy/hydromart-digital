...
export const hq = {
  ...
  vouchers: {
    ...
    requests: {
      ...
      emptyWhy: 'Antrean ini belum bisa terisi: tidak ada layar depot yang mengajukan permintaan voucher. Peran yang akan mengajukannya (MANAGER) sudah bisa membuat voucher langsung di /dashboard/vouchers, jadi jalur ini menunggu keputusan: apakah voucher depot harus lewat persetujuan HQ, atau layar ini yang dilepas.',
      by: 'Oleh #{who} · {depot}',
      approve: 'Setujui',
      reject: 'Tolak',
