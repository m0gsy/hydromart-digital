...
export const hrFix = {
  ...
  resellers: {
    ...
    effectiveAtHint: "Kosong = berlaku sekarang. Diisi tanggal ke depan = harga lama tetap dipakai sampai tanggal itu.",
    scheduled: "Perubahan dijadwalkan",
    nothingToSchedule: "Tanggal berlaku diisi tapi tidak ada perubahan harga atau status yang dijadwalkan.",
  ...
  accountEdit: {
    ...
    phone: "Nomor HP",
    phoneIsLogin: "Nomor ini yang dipakai untuk masuk. Menggantinya mengeluarkanmu dari semua perangkat.",
