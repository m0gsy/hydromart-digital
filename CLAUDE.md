...
2. .claude/MASTER_PROMPT.md
3. .claude/PLUGIN_ORCHESTRATION.md
4. .claude/EXECUTION_POLICY.md
5. .claude/ENGINEERING_CONSTITUTION.md
6. .claude/DESIGN_PRINCIPLES.md
7. .claude/QUALITY_GATES.md
8. .claude/MEMORY_PROTOCOL.md
9. .claude/REVIEW_TEMPLATE.md
10. .claude/COMMIT_RULES.md
...
- Update Claude Memory after every completed milestone.
