...
depot|stock_transfers_reference_key|CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS "stock_transfers_reference_key" ON "stock_transfers"("reference")
depot|stock_transfers_toDepotId_status_sentAt_idx|CREATE INDEX CONCURRENTLY IF NOT EXISTS "stock_transfers_toDepotId_status_sentAt_idx" ON "stock_transfers"("toDepotId", "status", "sentAt")
